...
//  (name: 'your name', username: 'your username'), rather than my information.
  ...
  //Code Here
user1["name"] = 'Chris'
user1["username"] = 'l33tH@x0r'
user1["pwHash"] = 'adadfajhdfk'
...
function makePerson (name2, bday2, ssn2) {
    var obj = {
    name: name2,
    birthday: bday2,
    ssn: ssn2,
...
a person or a credit card object.
   ...
   Have bindCard merge the two parameters together into a new object which contains all the properties 
    from the person as well as the creditcard. While Object.assign would give you the answer, specRunner requires an answer without using it.
*/
